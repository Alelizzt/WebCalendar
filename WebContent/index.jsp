...
<html>
	...
	<td id="aniotitulo">
		...
		try{
			...
			if(session.getAttribute("mes").toString().equals("1")){
				desface = 2;
			}
			if(session.getAttribute("mes").toString().equals("2")){
				desface = 5;
			}
			if(session.getAttribute("mes").toString().equals("3")){
				desface = 5;
			}
			if(session.getAttribute("mes").toString().equals("4")){
				desface = 2;
			}
			if(session.getAttribute("mes").toString().equals("5")){
				desface = 5;
			}
			if(session.getAttribute("mes").toString().equals("6")){
				desface = 5;
			}
			if(session.getAttribute("mes").toString().equals("7")){
				desface = 2;
			}
			if(session.getAttribute("mes").toString().equals("8")){
				desface = 5;
			}
			if(session.getAttribute("mes").toString().equals("9")){
				desface = 0;
			}
			if(session.getAttribute("mes").toString().equals("10")){
				desface = 2;
			}
			if(session.getAttribute("mes").toString().equals("11")){
				desface = 5;
			}
			if(session.getAttribute("mes").toString().equals("12")){
				desface = 0;
			}
		...
		%>
			...
			<div id="nuevoevento" style="display: none;">
				<div id="contieneform">
					...
					<form action="http://localhost:8088/WebCalendar/acciones/nuevoEvento.jsp" method="POST">
	...
	<div id="nuevocalendarioform" style="display: none;">
		<div id="contieneform">
			...
			<form
				action="http://localhost:8088/WebCalendar/acciones/nuevoCalendario.jsp"
				method="POST">
				<input type="hidden" name="anio" value="2014"> <input
					type="hidden" name="mes" value="9">
